 ...
 * 可用于 kbpd-form、kbpd-modal、kbpd-drawer 等组件使用,
 */

import type { Component } from 'vue';

import type { BaseFormComponentType } from '@kbpd/common-ui';
import type { Recordable } from '@kbpd/types';

import { defineAsyncComponent, defineComponent, h, ref } from 'vue';

import { ApiComponent, globalShareState, IconPicker } from '@kbpd/common-ui';
