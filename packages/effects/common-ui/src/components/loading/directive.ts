...
import { KbpdLoading, KbpdSpinner } from '@kbpd-core/shadcn-ui';
import { isString } from '@kbpd-core/shared/utils';
...
const loadingDirective: Directive = {
  mounted(el, binding) {
    const instance = h(KbpdLoading, getOptions(binding));
    render(instance, el);
...
const spinningDirective: Directive = {
  mounted(el, binding) {
    const instance = h(KbpdSpinner, getOptions(binding));
    render(instance, el);
