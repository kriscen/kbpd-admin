...
import type { MenuRecordRaw } from '@kbpd/types';

import { computed, onMounted, useSlots, watch } from 'vue';
import { useRoute } from 'vue-router';

import { useRefresh } from '@kbpd/hooks';
import { $t, i18n } from '@kbpd/locales';
import {
  preferences,
  updatePreferences,
  usePreferences,
...
import { cloneDeep, mapTree } from '@kbpd/utils';

import { KbpdAdminLayout } from '@kbpd-core/layout-ui';
import { KbpdBackTop, KbpdLogo } from '@kbpd-core/shadcn-ui';
