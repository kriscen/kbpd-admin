...
import type { TabDefinition } from '@kbpd/types';

import type { IContextMenuItem } from '@kbpd-core/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@kbpd/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { getTabKey, useAccessStore, useTabbarStore } from '@kbpd/stores';
import { filterTree } from '@kbpd/utils';
