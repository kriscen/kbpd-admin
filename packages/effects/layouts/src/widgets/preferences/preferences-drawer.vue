...
import type { SegmentedItem } from '@kbpd-core/shadcn-ui';

import { computed, ref } from 'vue';

import { Copy, RotateCw } from '@kbpd/icons';
...
<template>
  <div>
    ...
    >
      ...
      <div class="p-1">
        <KbpdSegmented v-model="activeTab" :tabs="tabs">
          <template #general>
