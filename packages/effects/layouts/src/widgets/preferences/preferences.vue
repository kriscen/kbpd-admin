...
import { Settings } from '@kbpd/icons';
import { $t, loadLocaleMessages } from '@kbpd/locales';
import { preferences, updatePreferences } from '@kbpd/preferences';
import { capitalizeFirstLetter } from '@kbpd/utils';

import { useKbpdDrawer } from '@kbpd-core/popup-ui';
import { KbpdButton } from '@kbpd-core/shadcn-ui';

import PreferencesDrawer from './preferences-drawer.vue';

const [Drawer, drawerApi] = useKbpdDrawer({
