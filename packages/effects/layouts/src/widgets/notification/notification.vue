...
import { Bell, MailCheck } from '@kbpd/icons';
  ...
  >
    <template #trigger>
      <div class="flex-center mr-2 h-full" @click.stop="toggle()">
        <KbpdIconButton class="bell-button text-foreground relative">
          <span
            v-if="dot"
    ...
    <div class="relative">
      ...
      <KbpdScrollbar v-if="notifications.length > 0">
      ...
      >
        ...
        <KbpdButton size="sm" @click="handleViewAll">
