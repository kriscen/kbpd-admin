...
import { LockKeyhole } from '@kbpd/icons';
import { $t, useI18n } from '@kbpd/locales';
import { storeToRefs, useAccessStore } from '@kbpd/stores';

import { useScrollLock } from '@kbpd-core/composables';
import { useKbpdForm, z } from '@kbpd-core/form-ui';
import { KbpdAvatar, KbpdButton } from '@kbpd-core/shadcn-ui';
...
const [Form, { form, validate }] = useKbpdForm(
  reactive({
    commonConfig: {
      hideLabel: true,
    ...
    schema: computed(() => [
      {
        component: 'KbpdInputPassword' as const,
        componentProps: {
    ...
    <transition name="slide-right">
      ...
      >
        <div class="flex-col-center mb-10 w-[90%] max-w-[300px] px-4">
          <KbpdAvatar :src="avatar" class="enter-x mb-6 size-20" />
          <div class="enter-x mb-2 w-full items-center">
            <Form />
          </div>
          <KbpdButton class="enter-x w-full" @click="handleSubmit">
