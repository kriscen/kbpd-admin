...
import { useForwardPropsEmits } from '@kbpd-core/composables';
import { ChevronLeft, ChevronRight } from '@kbpd-core/icons';
import { KbpdScrollbar } from '@kbpd-core/shadcn-ui';
...
const props = withDefaults(defineProps<Props>(), {
  contentClass: 'kbpd-tabs-content',
  draggable: true,
  styleType: 'chrome',
  wheelable: true,
});
