...
import type { KbpdButtonProps } from '@kbpd-core/shadcn-ui';
import type { ClassType, MaybeComputedRef } from '@kbpd-core/typings';
...
export interface ActionButtonOptions extends KbpdButtonProps {
  [key: string]: any;
  content?: MaybeComputedRef<string>;
  show?: boolean;
}

export interface KbpdFormProps<
  T extends BaseFormComponentType = BaseFormComponentType,
> extends Omit<
    FormRenderProps<T>,
...
export type ExtendedFormApi = FormApi & {
  useStore: <T = NoInfer<KbpdFormProps>>(
    selector?: (state: NoInfer<KbpdFormProps>) => T,
  ) => Readonly<Ref<T>>;
};

export interface KbpdFormAdapterOptions<
  T extends BaseFormComponentType = BaseFormComponentType,
> {
  config?: {
