...
import type { ExtendedFormApi, FormActions, KbpdFormProps } from './types';

import { computed, unref, useSlots } from 'vue';

import { createContext } from '@kbpd-core/shadcn-ui';
import { isString, mergeWithArrayOverride, set } from '@kbpd-core/shared/utils';

import { useForm } from 'vee-validate';
import { object, ZodIntersection, ZodNumber, ZodObject, ZodString } from 'zod';
import { getDefaultsForSchema } from 'zod-defaults';

type ExtendFormProps = KbpdFormProps & { formApi: ExtendedFormApi };
...
export function useFormInitial(
  props: ComputedRef<KbpdFormProps> | KbpdFormProps,
) {
