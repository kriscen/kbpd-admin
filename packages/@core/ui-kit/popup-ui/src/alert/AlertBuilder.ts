...
import type { Recordable } from '@kbpd-core/typings';

import type { AlertProps, BeforeCloseScope, PromptProps } from './alert';

import { h, nextTick, ref, render } from 'vue';

import { useSimpleLocale } from '@kbpd-core/composables';
import { Input, KbpdRenderContent } from '@kbpd-core/shadcn-ui';
import { isFunction, isString } from '@kbpd-core/shared/utils';
...
export function kbpdAlert(options: AlertProps): Promise<void>;
export function kbpdAlert(
  message: string,
...
export function kbpdConfirm(options: AlertProps): Promise<void>;
export function kbpdConfirm(
  message: string,
  options?: Partial<AlertProps>,
): Promise<void>;
export function kbpdConfirm(
...
export function kbpdConfirm(
  ...
  if (!arg1) {
    return isString(arg0)
      ? kbpdAlert(arg0, defaultProps)
      : kbpdAlert({ ...defaultProps, ...arg0 });
  } else if (!arg2) {
    return isString(arg1)
      ? kbpdAlert(arg0 as string, arg1, defaultProps)
      : kbpdAlert(arg0 as string, { ...defaultProps, ...arg1 });
  }
  return kbpdAlert(arg0 as string, arg1 as string, {
    ...defaultProps,
    ...arg2,
  });
}

export async function kbpdPrompt<T = any>(
  ...
  staticContents.push(h(KbpdRenderContent, { content, renderBr: true }));
