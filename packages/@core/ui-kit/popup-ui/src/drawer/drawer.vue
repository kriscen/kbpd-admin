...
import {
  ...
  usePriorityValues,
  useSimpleLocale,
} from '@kbpd-core/composables';
import { X } from '@kbpd-core/icons';
import {
  Separator,
  Sheet,
  SheetClose,
...
import { ELEMENT_ID_MAIN_CONTENT } from '@kbpd-core/shared/constants';
...
<template>
  ...
  >
    ...
    >
        ...
        <div class="flex items-center">
          ...
          <SheetTitle v-if="title" class="text-left">
            <slot name="title">
              ...
              <KbpdHelpTooltip v-if="titleTooltip" trigger-class="pb-1">
                {{ titleTooltip }}
              </KbpdHelpTooltip>
            </slot>
          </SheetTitle>
      ...
      <KbpdLoading v-if="showLoading || submitting" spinning />
      <SheetFooter
        v-if="showFooter"
        :class="
          cn(
      ...
      >
        ...
        <slot name="footer">
          <component
            :is="components.DefaultButton || KbpdButton"
          ...
          <component
            :is="components.PrimaryButton || KbpdButton"
